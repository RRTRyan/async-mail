package com.example.asyncmail.endpoint.event.consumer;

import com.example.asyncmail.PojaGenerated;
import com.example.asyncmail.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.example.asyncmail.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.example.asyncmail.service.event."
