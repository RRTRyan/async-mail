package com.example.asyncmail.handler;

import static com.example.asyncmail.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.example.asyncmail.PojaApplication;
import com.example.asyncmail.PojaGenerated;
import com.example.asyncmail.endpoint.EndpointConf;
import com.example.asyncmail.endpoint.event.EventConf;
import com.example.asyncmail.endpoint.event.consumer.EventConsumer;
import com.example.asyncmail.endpoint.event.consumer.model.ConsumableEvent;
import com.example.asyncmail.endpoint.event.consumer.model.ConsumableEventTyper;
